...
## Senaryo
Bir dosya sistemi yöneticisi geliştiriyoruz:

File -> yaprak düğüm, boyutu var, alt öğesi yok
Directory -> kompozit düğüm, dosya ve alt klasörler içerebilir
FileSystemItem -> her ikisini de temsil eden ortak interface

Client dosya mı klasör mü olduğunu bilmeden işlem yapabilmeli!
