...
Console.WriteLine("╚══════════════════════════════════════════════════════════════╝");
Console.WriteLine();
Console.WriteLine(" Her kullanıcı diğer tüm kullanıcıları doğrudan referans tutuyor.");
Console.WriteLine(" N kullanıcı için N*(N-1) bağımlılık oluşuyor.");
Console.WriteLine(" Yeni kullanıcı tipi eklemek tüm sınıfları değiştiriyor.");
Console.WriteLine(" Bot yalnızca RegularUser'a yanıt verebiliyor — AdminUser'a yanıt yok.");
Console.WriteLine();
