...
## Senaryo
Bir e-ticaret sitesinde müşteriler bilgisayar konfigürasyonu yapıyor:

GamingComputer → yüksek performanslı GPU, RAM, işlemci
OfficeComputer → orta seviye, verimlilik odaklı
ServerComputer → çok çekirdekli, yüksek RAM, RAID disk

Her bilgisayarın onlarca özelliği var — constructor'a hepsini geçmek Telescoping Constructor sorununu yaratıyor!
